...
class FreeTrialAreaTwo extends Component {
    render() {
        return (
            <section className="free-trial-area pb-100 bg-f4f5fe">
                <div className="container">
                    <div className="free-trial-content">
                        ...
                        <p>Qualify your leads & recognize the value of word, your customer will love you :D</p>
...
export default FreeTrialAreaTwo;