                                    ...
                                    <div className="col-lg-4 col-sm-6">
                                        <div className="single-pricing-table">
                                            ...
                                            <ul className="pricing-features">
                                                ...
                                                <li>
                                                    <i className="bx bxs-badge-check"></i> 
                                                    Free Landing page for your app
                                                </li>
                                                <li>
                                                    <i className="bx bxs-badge-check"></i> 
                                                    2 Months support after delivery.
                                                </li>
                                                <li>
                                                    <i className="bx bx-x-circle"></i> 
                                                    Uploading to Play and App Store
                                                </li>
                                                <li>
                                                <i className="bx bx-x-circle"></i> 
                                                ...
                                                <li>
                                                <i className="bx bx-x-circle"></i> 
                                                    Advanced features like chat and video support.
                                                </li>
                                    ...
                                    <div className="col-lg-4 col-sm-6">
                                        <div className="single-pricing-table">
                                            ...
                                            <ul className="pricing-features">
                                                ...
                                                <li>
                                                    <i className="bx bxs-badge-check"></i> 
                                                    Free landing page with Free domain.
                                                </li>
                                                <li>
                                                    <i className="bx bxs-badge-check"></i> 
                                                    6 Months support after delivery.
                                                </li>
                                                <li>
                                                    <i className="bx bxs-badge-check"></i> 
                                                    Uploading to play and app store
